...
/// validação de formulário e manipulação de erros. Após o login, uma mensagem de sucesso é exibida.
class LoginPage extends StatelessWidget {
  ...
  ///
  /// Este método valida o formulário, tenta autenticar o usuário com o AuthMethods, e exibe uma mensagem
